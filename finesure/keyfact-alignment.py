...
_model = "qwen2.5-14b-instruct"
_model = "qwen2.5-32b-instruct"
_model = "phi2"
_model = "Mixtral-8x7B-Instruct-v0.1"
_model = "Mixtral-8x7B-v0.1"
...
def main(input_path, keyfact_path, output_path, print_interval=2):
    ...
    raw_data_writer = open(os.path.join(output_path, f'raw-data-by-{_model}.json'), 'w')
    result_writer = open(os.path.join(output_path, f'realsumm-result-by-{_model}.json'), 'w')
